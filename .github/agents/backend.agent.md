...
5. **Test the endpoint** — Use VS Code's integrated browser to test API endpoints visually, or use `curl` commands in terminal to verify endpoints return correct responses for valid inputs and proper errors for invalid inputs.
