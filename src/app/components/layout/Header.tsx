        ...
        <header className="bg-teal-600 text-white shadow-sm"> 
            <div className="container mx-auto px-6 py-4 flex items-center justify-between"> 
                ...
                <div className="flex items-center space-x-3"> 
                    ...
                    <Link href="/cart" aria-label="Cart" className="relative p-2 rounded-full hover:bg-teal-700 transition-all duration-200"> 
                        ...
                        {itemCount > 0 && (
                            <span className="absolute -top-1 -right-1 bg-orange-400 text-white text-[11px] font-bold w-5 h-5 flex items-center justify-center rounded-full">
